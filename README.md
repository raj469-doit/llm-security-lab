...
excessive autonomy, injection-assisted launch, hallucination-triggered agency, tool
chain attacks, and emotional manipulation bypass. Tests agent DECISIONS not just
responses — evaluates whether the agent would invoke forbidden tools, chain dangerous
actions, or bypass human-in-the-loop controls. Four-layer detection including natural
language compliance analysis and multi-step chain detection.
